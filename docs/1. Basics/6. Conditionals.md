...
!!! example "Short Declaration in If"
    ...
    === "Basic Short Declaration"
        ```go title="short_declaration.go" linenums="1" hl_lines="7-9"
        package main
...
!!! example "Basic Switch Statements"
    ...
    === "Simple Switch"
        ```go title="simple_switch.go" linenums="1" hl_lines="8-16"
        package main
    ...
    === "Switch with Expression"
        ```go title="switch_expression.go" linenums="1" hl_lines="8-19"
        package main
    ...
    === "Switch with Short Declaration"
        ```go title="switch_short_declaration.go" linenums="1" hl_lines="9-18"
        package main
...
!!! example "Advanced Switch Usage"
    ...
    === "Multiple Values per Case"
        ```go title="multiple_values.go" linenums="1" hl_lines="8-15"
        package main
    ...
    === "Fallthrough Behavior"
        ```go title="fallthrough.go" linenums="1" hl_lines="8-19"
        package main
    ...
    === "Switch on Function Results"
        ```go title="function_results.go" linenums="1" hl_lines="15-22"
        package main
...
!!! example "Break out of Switch"

    === "Break With Label"
        ```go title="switch_break.go" linenums="1"
        func main() {
        Loop:
            for i := 0; i < 5; i++ {
                switch i {

...
!!! example "Basic Init Functions"
    ...
    === "Simple Initialization"
        ```go title="basic_init.go" linenums="1" hl_lines="8-11"
        package main
    ...
    === "Multiple Init Functions"
        ```go title="multiple_init.go" linenums="1" hl_lines="8-11 14-17"
        package main
    ...
    === "Package-Level Setup"
        ```go title="package_setup.go" linenums="1" hl_lines="14-30"
        package config
...
!!! example "Execution Order Examples"
    ...
    === "Single Package Order"
        ```go title="single_package_order.go" linenums="1" hl_lines="5-6 8-11 13-15 17 19-21"
        package main
    ...
    === "Multi-Package Dependencies"
        ```go title="package_a/init.go" linenums="1" hl_lines="5-7"
        package a
        ...
        ```go title="package_b/init.go" linenums="1" hl_lines="7-10"
        package b
        ...
        ```go title="main.go" linenums="1" hl_lines="7-9"
        package main
...
!!! example "Practical Applications"
    ...
    === "Database Connection Pool"
        ```go title="database_init.go" linenums="1" hl_lines="15-36"
        package database
    ...
    === "Logger Configuration"
        ```go title="logger_init.go" linenums="1" hl_lines="14-32"
        package logger
    ...
    === "Feature Flag Registration"
        ```go title="features_init.go" linenums="1" hl_lines="13-21"
        package features

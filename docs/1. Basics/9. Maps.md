...
!!! example "Basic Map Creation"
    ...
    === "Map Literals"
        ```go title="map_literals.go" linenums="1" hl_lines="7-11"
        package main
    ...
    === "Empty Map Declaration"
        ```go title="empty_maps.go" linenums="1" hl_lines="7-8 11-12"
        package main
    ...
    === "Different Key Types"
        ```go title="key_types.go" linenums="1" hl_lines="7 10 13"
        package main
...
!!! example "Using make for Maps"
    ...
    === "Basic make Usage"
        ```go title="make_maps.go" linenums="1" hl_lines="7 10-12"
        package main
    ...
    === "Capacity Hint"
        ```go title="map_capacity.go" linenums="1" hl_lines="7 10-12"
        package main
    ...
    === "Nil vs Empty Maps"
        ```go title="nil_vs_empty.go" linenums="1" hl_lines="7 10 17 18"
        package main
...
!!! example "Map Operations"
    ...
    === "Basic Access"
        ```go title="map_access.go" linenums="1" hl_lines="10 13 16"
        package main
    ...
    === "Safe Key Checking"
        ```go title="key_existence.go" linenums="1" hl_lines="9-11 14-18"
        package main
    ...
    === "Element Deletion"
        ```go title="map_deletion.go" linenums="1" hl_lines="12 15"
        package main
...
!!! example "Map Iteration"
    ...
    === "Keys and Values"
        ```go title="map_iteration.go" linenums="1" hl_lines="12-14"
        package main
    ...
    === "Keys Only"
        ```go title="keys_only.go" linenums="1" hl_lines="12-14"
        package main
    ...
    === "Values Only"
        ```go title="values_only.go" linenums="1" hl_lines="12-14"
        package main
...
!!! example "Advanced Map Types"
    ...
    === "Struct Keys"
        ```go title="struct_keys.go" linenums="1" hl_lines="14-18 21"
        package main
    ...
    === "Slice Values"
        ```go title="slice_values.go" linenums="1" hl_lines="9-13 16"
        package main
    ...
    === "Nested Maps"
        ```go title="nested_maps.go" linenums="1" hl_lines="9-12 16 20-22"
        package main
...
!!! example "Practical Patterns"
    ...
    === "Counting Occurrences"
        ```go title="counting.go" linenums="1" hl_lines="10-13"
        package main
    ...
    === "Set Implementation"
        ```go title="set_pattern.go" linenums="1" hl_lines="8 13-15 18-20 24-27"
        package main
    ...
    === "Grouping Data"
        ```go title="grouping.go" linenums="1" hl_lines="14 17-20"
        package main

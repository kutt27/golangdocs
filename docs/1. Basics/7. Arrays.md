...
!!! example "Array Declaration Methods"
    ...
    === "Zero Value Declaration"
        ```go title="zero_values.go" linenums="1" hl_lines="7-8"
        package main
    ...
    === "Literal Initialization"
        ```go title="literal_init.go" linenums="1" hl_lines="7-8"
        package main
    ...
    === "Compiler-Inferred Length"
        ```go title="inferred_length.go" linenums="1" hl_lines="7-8"
        package main
...
!!! example "Advanced Array Patterns"
    ...
    === "Partial Initialization"
        ```go title="partial_init.go" linenums="1" hl_lines="7 10"
        package main
    ...
    === "Multi-dimensional Arrays"
        ```go title="multidimensional.go" linenums="1" hl_lines="7-11 14-17"
        package main
...
!!! example "Array Element Operations"
    ...
    === "Basic Access and Modification"
        ```go title="array_access.go" linenums="1" hl_lines="9-10 13 17"
        package main
    ...
    === "Bounds Checking"
        ```go title="bounds_checking.go" linenums="1" hl_lines="9-11 14"
        package main
...
!!! example "Array Iteration Patterns"
    ...
    === "Traditional For Loop"
        ```go title="traditional_loop.go" linenums="1" hl_lines="9-11"
        package main
    ...
    === "Range Loop with Index and Value"
        ```go title="range_loop.go" linenums="1" hl_lines="9-11"
        package main
    ...
    === "Range Loop with Value Only"
        ```go title="value_only.go" linenums="1" hl_lines="9-11"
        package main
...
!!! example "Blank Identifier Usage"
    ...
    === "Ignoring Array Indices"
        ```go title="ignore_indices.go" linenums="1" hl_lines="9-11"
        package main
    ...
    === "Ignoring Array Values"
        ```go title="ignore_values.go" linenums="1" hl_lines="9-11 15-17"
        package main
    ...
    === "Function Return Values"
        ```go title="function_returns.go" linenums="1" hl_lines="17 21"
        package main
...
!!! example "Value Type Behavior"
    ...
    === "Array Copying"
        ```go title="array_copying.go" linenums="1" hl_lines="9-10"
        package main
    ...
    === "Function Parameters"
        ```go title="function_params.go" linenums="1" hl_lines="7 12 17 21 25"
        package main
...
!!! example "Comparing Arrays"
    ...
    === "Array Equality"
        ```go title="array_equality.go" linenums="1" hl_lines="11-13 16-18"
        package main

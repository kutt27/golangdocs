...
One of the key insight here is that, go uses 'utf-8' encoding stream to convert our program from human readable code to machine readable code. I have written a blog post on this same topic on C. You can check that out [here](https://amals27.hashnode.dev/deep-dive-into-hello-world).

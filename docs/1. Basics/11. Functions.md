...
!!! example "Basic Function Syntax"
    ...
    === "Simple Functions"
        ```go title="basic_functions.go" linenums="1" hl_lines="6-8 11-13 16-18"
        package main
    ...
    === "No Return Value"
        ```go title="void_functions.go" linenums="1" hl_lines="7-9 12-14"
        package main
    ...
    === "Complex Parameters"
        ```go title="complex_params.go" linenums="1" hl_lines="13-15 18-24"
        package main
...
!!! example "Multiple Return Values"
    ...
    === "Basic Multiple Returns"
        ```go title="multiple_returns.go" linenums="1" hl_lines="11-13 16-18 21-31"
        package main
    ...
    === "Named Return Values"
        ```go title="named_returns.go" linenums="1" hl_lines="6-10 13-23"
        package main
    ...
    === "Ignoring Return Values"
        ```go title="ignore_returns.go" linenums="1" hl_lines="11 15 19"
        package main
...
!!! example "Variadic Functions"
    ...
    === "Basic Variadic"
        ```go title="variadic_basic.go" linenums="1" hl_lines="6-12 15-24"
        package main
    ...
    === "Slice Expansion"
        ```go title="slice_expansion.go" linenums="1" hl_lines="10-16 26"
        package main
...
!!! example "Function Types"
    ...
    === "Function Variables"
        ```go title="function_variables.go" linenums="1" hl_lines="6 13-15 22 26"
        package main
    ...
    === "Anonymous Functions"
        ```go title="anonymous_functions.go" linenums="1" hl_lines="7-9 12-14 20-24 26-28"
        package main
    ...
    === "Closures"
        ```go title="closures.go" linenums="1" hl_lines="6-12 15-19"
        package main
...
!!! example "Recursion Patterns"
    ...
    === "Basic Recursion"
        ```go title="recursion_basic.go" linenums="1" hl_lines="6-11 14-19"
        package main
    ...
    === "Tail Recursion"
        ```go title="tail_recursion.go" linenums="1" hl_lines="6-11 19-24"
        package main

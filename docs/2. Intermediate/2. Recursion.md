...
1. **Mathematical sequences** (like Factorial or Fibonacci).
2. **Navigating tree-like structures** (like file directories or JSON objects). Particularly in graph structures, we use recursion to reach nodes.
